...
public class EntityMonsterPlacer extends ItemMonsterPlacer
{
    ...
    public EntityMonsterPlacer()
    {
        super();
    }
    
    public EntityMonsterPlacer(String parEntityToSpawnName, int parPrimaryColor, 
...
//       System.out.println("Spawn egg constructor for "+entityToSpawnName);
    ...
    public Entity spawnEntity(World parWorld, double parX, double parY, double parZ)
    {
       ...
       {
            entityToSpawnNameFull = curtcraft.MODID+"."+entityToSpawnName;
